...
-- -----------------------------------------------------
-- Table `stronsen_capstone262`.`order_hours`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `stronsen_capstone262`.`order_hours` (
  `order_hours_day` INT NOT NULL,
  `order_hours_open` TIME NOT NULL,
  `order_hours_close` TIME NOT NULL,
  `order_hours_modification_user` VARCHAR(75) NOT NULL,
  `order_hours_modification_time` DATETIME NOT NULL,
  PRIMARY KEY (`order_hours_day`))
ENGINE = InnoDB;
